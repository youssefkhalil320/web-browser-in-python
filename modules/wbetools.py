        ...
        if isinstance(new_cls, type):  # Patching classes
            ...
            for attr in dir(new_cls):
                ...
                if attr in ["__code__", "__module__", "__defaults__", "__annotations__"]:
                    ...
                    assert getattr(
                        existing_cls, attr) is None, "Cannot patch a closure"
